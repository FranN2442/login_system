...
function create(){
    ...
    $query = "INSERT INTO " . $this->table_name . " 
          (id,firstname, lastname, email, contact_number, address, password, access_level, access_code, status, created) 
          VALUES 
          (60,:firstname, :lastname, :email, :contact_number, :address, :password, :access_level, :access_code, :status, :created)";
